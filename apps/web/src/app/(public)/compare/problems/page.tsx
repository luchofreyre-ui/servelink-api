...
import { buildAuthorityCompareProblemsIndexMetadata } from "@/authority/metadata/authorityMetadata";
import {
...
export const metadata: Metadata = buildAuthorityCompareProblemsIndexMetadata();

const HUB_TITLE = "Compare problems";
const HUB_DESCRIPTION =
  "Structured comparisons between cleaning problems from the authority graph—category, symptoms, and linked playbooks.";

export default function CompareProblemsIndexPage() {
  const seeds = getComparisonSeedsByType("problem_comparison");
  const indexJsonLd = [
    buildBreadcrumbListSchema([
      { label: "Cleaning encyclopedia", href: "/encyclopedia" },
      { label: HUB_TITLE, href: "/compare/problems" },
    ]),
    buildCollectionPageSchema({
      title: HUB_TITLE,
      description: HUB_DESCRIPTION,
      path: "/compare/problems",
    }),
  ];

...
import type { SystemTestIncidentActionPriority } from "@/types/systemTestIncidentActions";

const PRIORITIES: SystemTestIncidentActionPriority[] = [
  "critical",
  "high",
  "medium",
  "low",
...
export function SystemTestIncidentPriorityControl({
  incidentKey,
  priority,
  disabled,
  onUpdated,
  ...
  const [value, setValue] = useState<SystemTestIncidentActionPriority>(priority);
    ...
    <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        <select
          ...
          onChange={(e) => setValue(e.target.value as SystemTestIncidentActionPriority)}
        ...
        <button
          ...
          onClick={async () => {
            ...
            setSaving(true);
            try {
              await updatePriority({ incidentKey, priority: value });
              await onUpdated();
            } catch (e) {

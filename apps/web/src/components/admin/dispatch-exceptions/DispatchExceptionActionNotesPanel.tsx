...
import type { DispatchExceptionActionNote } from "@/types/dispatchExceptionActions";
...
export function DispatchExceptionActionNotesPanel({
  notes,
      ...
      <div className="mt-4 border-t border-white/10 pt-4">
        ...
        <button
          ...
          onClick={async () => {
            ...
            setSaving(true);
            try {
              await onAddNote({ dispatchExceptionKey, text: t });
              setText("");
            } catch (e) {

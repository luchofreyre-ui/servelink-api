...
import { evaluateMaintenanceEvolutionFromEstimateContext } from "../../estimating/maintenance-state/maintenance-evolution-from-estimate-context";
...
export class EstimatorService {
  ...
  private async executeEstimateCore(
    ...
    const maintenanceStateEvolution = evaluateMaintenanceEvolutionFromEstimateContext({
      input,
      confidenceBreakdown,
      escalationGovernance,

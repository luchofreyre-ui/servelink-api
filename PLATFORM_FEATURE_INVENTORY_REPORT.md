...
| **Stripe webhook ingestion** | Receives Stripe events; idempotent receipt table. | Payment truth vs platform state. | `StripeWebhookController`, `StripeWebhookHandlerService`, `StripeWebhookReceipt` model | **Implemented** (Backend) |

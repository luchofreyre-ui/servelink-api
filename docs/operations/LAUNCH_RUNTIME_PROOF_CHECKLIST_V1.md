...
3. Health/readiness response excerpts.
4. Auth route parity excerpt.
5. Manual subsystem proof excerpts.
6. `ENABLE_*` env snapshot excerpt for touched subsystem only.
7. Rollback plan and rollback proof if exercised.
8. Operator/on-call identity and timestamp.
